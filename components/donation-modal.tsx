          ...
          <div className="p-4 sm:p-6">
            <div className="flex items-center justify-between mb-4 sm:mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-slate-600">{sStep === 1 ? "Enter details" : "Confirm & pay"}</p>
                </div>
              </div>
              <button className="text-slate-400 hover:text-slate-600 hover:bg-slate-100 p-1 sm:p-2 rounded-lg" onClick={onClose}>
            ...
            {sStep === 1 && (
              ...
              >
                {/* Amount */}
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-slate-900 mb-3">Donation Amount</h3>
                ...
                {/* Payment method */}
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-slate-900 mb-3">Payment Method</h3>
                  <div className="space-y-2">
                    <label className="flex items-center p-3 border-2 rounded-xl cursor-pointer hover:bg-slate-50">
                      <input
                        type="radio"
                        name="paymentMethod"
                        value="orange-money"
                      ...
                      <div className="flex-1">
                        <span className="font-semibold text-slate-900 text-sm">Orange Money</span>
                        <p className="text-xs text-slate-600">Pay with your Orange Money wallet</p>
                      </div>
                    </label>
                    ...
                    <label className="flex items-center p-3 border-2 rounded-xl cursor-pointer hover:bg-slate-50">
                      ...
                      <div className="flex-1">
                        <span className="font-semibold text-slate-900 text-sm">Africell Money</span>
                        <p className="text-xs text-slate-600">Pay with your Africell Money wallet</p>
                      </div>
                    </label>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <h3 className="text-base sm:text-lg font-semibold text-slate-900">Your Details</h3>
                  <input
                    type="tel"
            ...
            {sStep === 2 && (
              <div className="space-y-5">
                ...
                <div className="bg-slate-50 rounded-xl p-3">
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div>
                      ...
                      <p className="font-semibold">{formatCurrency(selectedAmount || Number.parseInt(customAmount) || 0)}</p>
                    </div>
                    <div>
                ...
                <button
                  onClick={onClose}
                  className="w-full bg-gradient-to-r from-green-600 to-emerald-600 text-white py-3 rounded-xl hover:from-green-700 hover:to-emerald-700 font-semibold shadow-lg"
                >
                  Done
                </button>
              </div>
            ...
            <div className="mt-6 flex items-center justify-center text-xs text-slate-500 bg-slate-50 rounded-lg p-2">
